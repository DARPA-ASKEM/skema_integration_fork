...
from skema.gromet.execution_engine.types.defined_types import (
    Record,
    RecordField,
)
...
def new_Field(
    record_input: Record, field_name: str, value_type: type
) -> Record:
    return record_input.fields.append(
        RecordField(field_name, value_type, None)
    )  # #TODO: Do we need to set a default value?
